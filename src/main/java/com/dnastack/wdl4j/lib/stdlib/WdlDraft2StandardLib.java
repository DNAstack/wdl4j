...
public class WdlDraft2StandardLib implements StandardLib {
    ...
    private static Map<String, EngineFunction> registerFunctions() {
        ...
        map.put("read_float", new ReadFloat());
    ...
    @Override
    public Type evaluateReturnType(String name, List<Type> arguments, CoercionOptions options) throws WdlValidationError {
        EngineFunction function = getFunction(name);
        function.checkArity(arguments);
        return function.evaluateReturnType(arguments, options);
    }
