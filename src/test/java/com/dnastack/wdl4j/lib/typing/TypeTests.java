...
public class TypeTests {
    ...
    private CoercionOptions v1CoercionOptions = new CoercionOptions(LanguageLevel.WDL_V1);
    private CoercionOptions draft2CoercionOptions = new CoercionOptions(LanguageLevel.WDL_DRAFT_2);
    ...
    public void testStringTypeCoercions() {
        ...
        Assertions.assertTrue(type.isCoercibleTo(v1CoercionOptions, type));
        Assertions.assertTrue(type.isCoercibleTo(v1CoercionOptions, OptionalType.getType(type)));
        Assertions.assertTrue(type.isCoercibleTo(v1CoercionOptions, FileType.getType()));
        Assertions.assertTrue(type.isCoercibleTo(v1CoercionOptions, OptionalType.getType(FileType.getType())));

        Assertions.assertTrue(type.isCoercibleTo(v1CoercionOptions, IntType.getType()));
        Assertions.assertTrue(type.isCoercibleTo(v1CoercionOptions, OptionalType.getType(IntType.getType())));

        Assertions.assertTrue(type.isCoercibleTo(v1CoercionOptions, FloatType.getType()));
        Assertions.assertTrue(type.isCoercibleTo(v1CoercionOptions, OptionalType.getType(FloatType.getType())));

        Assertions.assertFalse(type.isCoercibleTo(v1CoercionOptions, BooleanType.getType()));
        Assertions.assertFalse(type.isCoercibleTo(v1CoercionOptions, OptionalType.getType(BooleanType.getType())));
        Assertions.assertFalse(type.isCoercibleTo(v1CoercionOptions,
                                                  MapType.getType(AnyType.getType(), AnyType.getType())));
        Assertions.assertFalse(type.isCoercibleTo(v1CoercionOptions,
                                                  PairType.getType(AnyType.getType(), AnyType.getType())));
        Assertions.assertFalse(type.isCoercibleTo(v1CoercionOptions, ArrayType.getType(AnyType.getType(), false)));
        Assertions.assertFalse(type.isCoercibleTo(v1CoercionOptions, StructType.getType("test")));
        Assertions.assertFalse(type.isCoercibleTo(v1CoercionOptions, ObjectType.getType()));
    ...
    public void testIntTypeCoercions() {
        ...
        Assertions.assertTrue(type.isCoercibleTo(v1CoercionOptions, type));
        Assertions.assertTrue(type.isCoercibleTo(v1CoercionOptions, OptionalType.getType(type)));
        Assertions.assertTrue(type.isCoercibleTo(v1CoercionOptions, StringType.getType()));
        Assertions.assertTrue(type.isCoercibleTo(v1CoercionOptions, OptionalType.getType(StringType.getType())));
        Assertions.assertTrue(type.isCoercibleTo(v1CoercionOptions, FloatType.getType()));
        Assertions.assertTrue(type.isCoercibleTo(v1CoercionOptions, OptionalType.getType(FloatType.getType())));
        Assertions.assertFalse(type.isCoercibleTo(v1CoercionOptions, BooleanType.getType()));
        Assertions.assertFalse(type.isCoercibleTo(v1CoercionOptions, OptionalType.getType(BooleanType.getType())));
        Assertions.assertFalse(type.isCoercibleTo(v1CoercionOptions, FileType.getType()));
        Assertions.assertFalse(type.isCoercibleTo(v1CoercionOptions, OptionalType.getType(FileType.getType())));
        Assertions.assertFalse(type.isCoercibleTo(v1CoercionOptions,
                                                  MapType.getType(AnyType.getType(), AnyType.getType())));
        Assertions.assertFalse(type.isCoercibleTo(v1CoercionOptions,
                                                  PairType.getType(AnyType.getType(), AnyType.getType())));
    ...
    public void testFloatTypeCoercions() {
        ...
        Assertions.assertTrue(type.isCoercibleTo(v1CoercionOptions, StringType.getType()));
        Assertions.assertTrue(type.isCoercibleTo(v1CoercionOptions, OptionalType.getType(StringType.getType())));
        Assertions.assertFalse(type.isCoercibleTo(v1CoercionOptions, IntType.getType()));
        Assertions.assertFalse(type.isCoercibleTo(v1CoercionOptions, OptionalType.getType(IntType.getType())));
        Assertions.assertFalse(type.isCoercibleTo(v1CoercionOptions, BooleanType.getType()));
        Assertions.assertFalse(type.isCoercibleTo(v1CoercionOptions, OptionalType.getType(BooleanType.getType())));
        Assertions.assertFalse(type.isCoercibleTo(v1CoercionOptions, FileType.getType()));
        Assertions.assertFalse(type.isCoercibleTo(v1CoercionOptions, OptionalType.getType(FileType.getType())));
    ...
    public void testBooleanTypeCoercions() {
        ...
        Assertions.assertFalse(type.isCoercibleTo(v1CoercionOptions, IntType.getType()));
        Assertions.assertFalse(type.isCoercibleTo(v1CoercionOptions, OptionalType.getType(IntType.getType())));
        Assertions.assertFalse(type.isCoercibleTo(v1CoercionOptions, FloatType.getType()));
        Assertions.assertFalse(type.isCoercibleTo(v1CoercionOptions, OptionalType.getType(FloatType.getType())));
        Assertions.assertFalse(type.isCoercibleTo(v1CoercionOptions, FileType.getType()));
        Assertions.assertFalse(type.isCoercibleTo(v1CoercionOptions, OptionalType.getType(FileType.getType())));
        Assertions.assertFalse(type.isCoercibleTo(v1CoercionOptions,
                                                  MapType.getType(AnyType.getType(), AnyType.getType())));
    ...
    public void testOptionalTypeCannotCoerceToNonOptional() {
        Assertions.assertFalse(OptionalType.getType(AnyType.getType())
                                           .isCoercibleTo(v1CoercionOptions, AnyType.getType()));
    }

    @Test
    public void testArrayTypeCoercions() {
        ArrayType baseType = ArrayType.getType(AnyType.getType());
        Assertions.assertTrue(baseType.isCoercibleTo(v1CoercionOptions, baseType));
        Assertions.assertTrue(baseType.isCoercibleTo(v1CoercionOptions, OptionalType.getType(baseType)));
        //Cannot convert empty to non empty
        Assertions.assertFalse(baseType.isCoercibleTo(v1CoercionOptions, ArrayType.getType(AnyType.getType(), true)));
        //Can convert non empty to emtpy
        Assertions.assertTrue(ArrayType.getType(AnyType.getType(), true).isCoercibleTo(v1CoercionOptions, baseType));
        //Inner type conversions
        Assertions.assertTrue(ArrayType.getType(StringType.getType())
                                       .isCoercibleTo(v1CoercionOptions, ArrayType.getType(FileType.getType())));
        Assertions.assertTrue(ArrayType.getType(StringType.getType())
                                       .isCoercibleTo(v1CoercionOptions, ArrayType.getType(IntType.getType())));
        Assertions.assertFalse(ArrayType.getType(FloatType.getType())
                                        .isCoercibleTo(v1CoercionOptions, ArrayType.getType(FileType.getType())));

        //Special String Coercioon
        Assertions.assertTrue(ArrayType.getType(StringType.getType())
                                       .isCoercibleTo(v1CoercionOptions, StringType.getType()));
        Assertions.assertTrue(ArrayType.getType(IntType.getType())
                                       .isCoercibleTo(v1CoercionOptions, StringType.getType()));
        Assertions.assertTrue(ArrayType.getType(FloatType.getType())
                                       .isCoercibleTo(v1CoercionOptions, StringType.getType()));
        Assertions.assertTrue(ArrayType.getType(FileType.getType())
                                       .isCoercibleTo(v1CoercionOptions, StringType.getType()));

        Assertions.assertFalse(baseType.isCoercibleTo(v1CoercionOptions,
                                                      MapType.getType(AnyType.getType(), AnyType.getType())));
        Assertions.assertFalse(baseType.isCoercibleTo(v1CoercionOptions,
                                                      PairType.getType(AnyType.getType(), AnyType.getType())));
        Assertions.assertFalse(baseType.isCoercibleTo(v1CoercionOptions, StructType.getType("test")));
        Assertions.assertFalse(baseType.isCoercibleTo(v1CoercionOptions, ObjectType.getType()));
    ...
    public void testMapTypeCoercions() {
        ...
        Assertions.assertFalse(baseType.isCoercibleTo(v1CoercionOptions, structType));
        ...
        Assertions.assertTrue(MapType.getType(StringType.getType(), FileType.getType(), Arrays.asList("valid1"))
                                     .isCoercibleTo(v1CoercionOptions, structType));
        ...
        Assertions.assertFalse(baseType.isCoercibleTo(v1CoercionOptions, BooleanType.getType()));
        Assertions.assertFalse(baseType.isCoercibleTo(v1CoercionOptions, StringType.getType()));
        Assertions.assertFalse(baseType.isCoercibleTo(v1CoercionOptions, FileType.getType()));
        Assertions.assertFalse(baseType.isCoercibleTo(v1CoercionOptions, IntType.getType()));
        Assertions.assertFalse(baseType.isCoercibleTo(v1CoercionOptions, FloatType.getType()));
        Assertions.assertFalse(baseType.isCoercibleTo(v1CoercionOptions, ArrayType.getType(AnyType.getType())));
        Assertions.assertFalse(baseType.isCoercibleTo(v1CoercionOptions,
                                                      PairType.getType(AnyType.getType(), AnyType.getType())));
        Assertions.assertFalse(baseType.isCoercibleTo(v1CoercionOptions, ObjectType.getType()));
    }
    ...
    public void testObjectTypeCoercion() {
        ...
        Assertions.assertTrue(ObjectType.getType(objectMembers).isCoercibleTo(v1CoercionOptions, structType));
        structMembers.put("valid2", IntType.getType());
        //object with some keys but no all cannnot map into struct
        Assertions.assertFalse(ObjectType.getType(objectMembers).isCoercibleTo(v1CoercionOptions, structType));
    ...
    public void testStructTypeCoercions() {
        ...
        Map<String, Type> structMembers = new HashMap<>();
        structMembers.put("valid1", FileType.getType());
        Assertions.assertFalse(baseType.isCoercibleTo(v1CoercionOptions, StructType.getType("test2")));
        Assertions.assertFalse(baseType.isCoercibleTo(v1CoercionOptions, StructType.getType("test2", structMembers)));
        Assertions.assertTrue(baseType.isCoercibleTo(v1CoercionOptions, StructType.getType("test", structMembers)));

        Assertions.assertTrue(StructType.getType("test", structMembers)
                                        .isCoercibleTo(v1CoercionOptions, StructType.getType("test", structMembers)));
